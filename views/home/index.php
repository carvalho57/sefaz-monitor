  ...
  <div class="container" style="visibility: hidden">
    <div class="mapa">
      <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        xml:space="preserve">
        <g>
          <a xlink:href="#tocantins" class="estado" uf="TO" nome="Tocantins">
          ...
          <a xlink:href="#bahia" class="estado" uf="BA" nome="Bahia">
            <title>Bahia</title>
          ...
          <a xlink:href="#sergipe" class="estado" uf="SE" nome="Sergipe">
            <title>Sergipe</title>
          ...
          <a xlink:href="#pernambuco" class="estado" uf="PE" nome="Pernambuco">
          ...
          <a xlink:href="#alagoas" class="estado" uf="AL" nome="Alagoas">
            <title>Alagoas</title>
          ...
          <a xlink:href="#riograndedonorte" class="estado" uf="RN" nome="Rio Grande do Norte">
          ...
          <a xlink:href="#ceara" class="estado" uf="CE" nome="Ceará">
            <title>Ceará</title>
          ...
          <a xlink:href="#piaui" class="estado" uf="PI" nome="Piauí">
            <title>Piauí</title>
          ...
          <a xlink:href="#maranhao" class="estado" uf="MA" nome="Maranhão">
          ...
          <a xlink:href="#amapa" class="estado" uf="AP" nome="Amapá">
            <title>Amapá</title>
          ...
          <a xlink:href="#para" class="estado" uf="PA" nome="Pará">
            <title>Pará</title>
          ...
          <a xlink:href="#roraima" class="estado" uf="RR" nome="Roraima">
            <title>Roraima</title>
          ...
          <a xlink:href="#amazonas" class="estado" uf="AM" nome="Amazonas">
          ...
          <a xlink:href="#acre" class="estado" uf="AC" nome="Acre">
            <title>Acre</title>
            <path stroke="#FFFFFF" stroke-width="1.0404" stroke-linecap="round" stroke-linejoin="round"
              d="M3.656,148.545
          ...
          </a><a xlink:href="#rondonia" class="estado" uf="RO" nome="Rondônia">
          ...
          <a xlink:href="#matogrosso" class="estado" uf="MT" nome="Mato Grosso">
          ...
          <a xlink:href="#matogrossodosul" class="estado" uf="MS" nome="Mato Grosso do Sul">
          ...
          <a xlink:href="#goias" class="estado" uf="GO" nome="Goiás">
            <title>Goiás</title>
            <path stroke="#FFFFFF" stroke-width="1.0404" stroke-linecap="round" stroke-linejoin="round"
              d="M237.768,270.519
          ...
          <a xlink:href="#parana" class="estado" uf="PR" nome="Paraná">
            <title>Paraná</title>
          ...
          <a xlink:href="#santacatarina" class="estado" uf="SC" nome="Santa Catarina">
          ...
          <a xlink:href="#riograndedosul" class="estado" uf="RS" nome="Rio Grande do Sul">
          ...
          <a xlink:href="#saopaulo" class="estado" uf="SP" nome="São Paulo">
          ...
          <a xlink:href="#minasgerais" class="estado" uf="MG" nome="Minas Gerais">
          ...
          <a xlink:href="#riodejaneiro" class="estado" uf="RJ" nome="Rio de Janeiro">
          ...
          <a xlink:href="#espiritosanto" class="estado" uf="ES" nome="Espírito Santo">
          ...
          <a xlink:href="#distritofederal" class="estado" uf="DF" nome="Distrito Federal">
      ...
      <div class="legend" style="visibility: hidden">
        ...
        <span class="label contingency">Contingência</span>
      </div>
    </div>
    <div class="card">
